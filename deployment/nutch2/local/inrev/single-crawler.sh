...
cp inrev/1.regex-urlfilter.txt conf/regex-urlfilter.txt
cp inrev/1.nutch-default.xml conf/nutch-default.xml
...
do
  ...
  cp inrev/$a.regex-urlfilter.txt conf/regex-urlfilter.txt

  # copy nutch-default
  cp inrev/$a.nutch-default.xml conf/nutch-default.xml
...
#    __bin_nutch solrdedup $commonOptions $SOLRURL
      ...
      echo "Skipping indexing of seed urls.";
  fi
